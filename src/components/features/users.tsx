...
export function UsersTable() {
  ...
  const [selectedUser, setSelectedUser] = useState<typeof initialUsers[0] | null>(
    null
  );
        ...
        <CardContent className="pt-2">
          <div className="w-full flex-grow rounded-md border p-2 mb-2">
            <TableComponent className="min-w-0 w-full">
              <TableCaption className="text-sm font-normal">
              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead
                    className="text-center text-sm font-semibold px-1 h-10 align-middle whitespace-nowrap truncate hidden sm:table-cell"
                  ...
                  <TableHead className="text-center text-sm font-semibold px-1 h-10 align-middle whitespace-nowrap truncate">
                    Actions
                  </TableHead>
                </TableRow>
              </TableHeader>
                ...
                {paginatedData.length ? (
                  paginatedData.map((user, index) => (
                    <TableRow key={`${user.username}-${index}`}>
                      ...
                      <TableCell
                        className="text-center px-1 py-1 text-xs truncate text-ellipsis overflow-hidden hidden sm:table-cell"
                        title={user.tier}
                      >
                        {user.tier}
                      </TableCell>
                      ...
                      <TableCell
                        className="text-center px-1 py-1 text-xs truncate text-ellipsis overflow-hidden"
                        title={user.dateCreated}
                      >
                        {user.dateCreated}
                      </TableCell>
                      <TableCell
                        className="text-center px-1 py-1 text-xs truncate text-ellipsis overflow-hidden"
                        title={user.dateModified}
                      >
                        {user.dateModified}
                      </TableCell>
                      <TableCell className="text-center px-1 py-1 flex gap-1 justify-center">
                        <Dialog>
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={9}
                      className="h-24 text-center text-sm font-normal"
                    >
                      No results.
                    </TableCell>
                  </TableRow>
